                                        ...
                                        <li class=" quantity_li" style="padding-top: 0px;
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary quantity-plus cart_button" type="button" ng-click="updateCart(product, 'add')"><i class="fa fa-plus" aria-hidden="true" ></i></button>
                                                </span>
                                                <span class="input-group-btn">
                                                    <button class="btn btn-primary quantity-minus cart_button" type="button" ng-click="updateCart(product, 'sub')"><i class="fa fa-minus" aria-hidden="true" ></i></button>
                                                </span>
                                            </div><!-- /input-group -->
                                        </li>
                                    </ul>
                                    ...
                                    <div class="coupon_form" >
                                        <form ng-if="globleCartData.coupon.has_coupon != '1'" action="<?php echo site_url("Cart/applyCoupon") ?>" method="post">
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-primary quantity-plus" type="submit"  style="    padding: 0px 11px;"><i class="fa fa-check" aria-hidden="true" ></i> Apply Coupon</button>
                                        ...
                                        <span ng-if="globleCartData.coupon.has_coupon == '1'">
                                            <div class="col-md-12">
                                                ...
                                                <button class="btn btn-primary removecouponbutton" ng-click="removeCoupon()" style="    padding: 0px 11px;">Remove Coupon</button>
                                            </div>
